...
//    }
    public static void setClip(int minX, int maxX, int minY, int maxY) {
        xMin = minX;
        xMax = maxX;
        yMin = minY;
        yMax = maxY;
    ...
    private final static int regionCode(double x, double y) {
        int code = x < xMin 
            ? LEFT
            : x > xMax
                ? RIGHT
     ...
     */
    public static boolean clip(Line2D line) {
