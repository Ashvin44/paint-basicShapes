...
public class Rotation_fixed_point  extends Transformation{
	
	private double angle;
	private int xOffset;
	private int yOffset;
	
	public Rotation_fixed_point(double angle, int xOff, int yOff) {
		super();
		this.angle = angle;		
		this.xOffset = xOff;
		this.yOffset = yOff;
		super.setType(Type.Rotation_fixed_point);
		updateMatrix();
	}
